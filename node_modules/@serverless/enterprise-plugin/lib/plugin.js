...
class ServerlessEnterprisePlugin {
  ...
  asyncInit() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (missingConfigSettings.length === 0 && isAuthenticated() && !['login', 'logout', 'generate-event'].includes(currentCommand)) {
      ...
      if (_this2.sls.enterpriseEnabled) {
        if (!_this2.sls.isStandaloneExecutable && !_this2.sls.interactiveCli) {
