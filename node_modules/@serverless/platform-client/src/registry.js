...
const zipPackage = async (registryPackage) => {
  ...
  const registryPackagePath = path.join(tmpdir(), `${Math.random().toString(36).substring(6)}.zip`);
  ...
  // include them...
  include = include.concat(configFilesToInclude);
  ...
  await utils.zip(registryPackage.src, registryPackagePath, [], exclude, include);
